...
" hi! link = force to be _NameTolink_ _LinkName_
" Example:
" hi! Name           ctermfg=Black    ctermbg=White   cterm=italic
" hi! link           NameToLink       Name
" -------------------------------------------------------------------- "

"  Type              Text            Background      Style
" ------------------------- Mode Settings --------------------------- "
hi Normal            ctermfg=none    ctermbg=029     cterm=none
...
hi ModeMsg           ctermfg=none    ctermbg=none    cterm=none " Shows insert mode ... etc
...
hi Type              ctermfg=none    ctermbg=none    cterm=none "void, int, float, double 
hi StorageClass      ctermfg=none    ctermbg=none    cterm=none "const, volatile, static
